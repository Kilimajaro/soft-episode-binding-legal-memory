...
\end{table}""",
    ...
    t = replace_once(
        ...
        r"""Code, configuration files, per-query JSON outputs, and evaluation scripts are released at \url{https://github.com/Kilimajaro/Vector-Memory-Is-All-You-Need} under tag \texttt{ipm-legal-revision-20260720}, aligned with this manuscript.""",
        "repro-url",
    )
