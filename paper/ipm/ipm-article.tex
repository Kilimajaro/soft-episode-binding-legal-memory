...
\begin{table}[t]
\centering
\caption{Corrected graded nDCG@10 (fixed-gold IDCG) on LegalEp primary channels under a fresh FlatIP rebuild. Soft~O2 reduces incompleteness while raising AH and corrected nDCG.}
