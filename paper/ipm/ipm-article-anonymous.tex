...
CAIL & Uk-followup & FlatIP & 0.458 & 0.445 & 54.0\% \\
CAIL & Uk-followup & Soft O2 & 0.928 & 0.793 & 7.0\% \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{CAIL2024 shared-corpus results ($M\approx 3000$). Boldface marks the best AH@10 within each channel (ties bolded jointly). ${}^{**}$: Soft~O2 vs FlatIP, McNemar mid-$p{<}0.01$. nDCG@10 marked --- pending fixed-gold IDCG recompute (Section~\ref{sec:protocol}); AH/EC unchanged.}
\label{tab:cail_main}
\compacttab\footnotesize
\begin{tabular}{@{}llcccc@{}}
\toprule
...
\midrule
\multirow{4}{*}{U1}
 & FlatIP & 0.570 & 0.413 & --- & [0.530,0.610] \\
 & Soft O2 & 0.788 & 0.664 & --- & [0.757,0.820] \\
 & Hard hydr. & \textbf{0.802} & 0.578 & --- & [0.768,0.835] \\
 & Shuffled O2 & 0.452 & 0.363 & --- & [0.410,0.492] \\
\midrule
\multirow{4}{*}{Uk-followup}
 & FlatIP & 0.270 & 0.347 & --- & [0.237,0.307] \\
 & Soft O2 & 0.698 & 0.654 & --- & [0.660,0.735] \\
 & Hard hydr. & \textbf{0.720} & 0.585 & --- & [0.685,0.753] \\
 & Shuffled O2 & 0.230 & 0.320 & --- & [0.198,0.262] \\
\midrule
\multirow{4}{*}{U-last}
 & FlatIP & 0.245 & 0.335 & --- & [0.212,0.280] \\
 & Soft O2 & 0.762 & 0.659 & --- & [0.725,0.797] \\
 & Hard hydr. & \textbf{0.790} & 0.586 & --- & [0.757,0.822] \\
 & Shuffled O2 & 0.200 & 0.315 & --- & [0.172,0.232] \\
\bottomrule
\end{tabular}
\end{table}
{\footnotesize $^\dagger$Legacy retrieved-item IDCG values removed from this grid; Soft~O2 claims use AH/EC. Corrected nDCG script: \texttt{recompute\_corrected\_metrics.py}.}
...
\multirow{4}{*}{advice-recall}
 & FlatIP & 0.342 & 0.438 & --- \\
 & Soft O2 & \textbf{0.428} & 0.503 & --- \\
 & Hard hydr. & 0.402 & 0.405 & --- \\
 & Shuffled O2 & 0.310 & 0.421 & --- \\
\midrule
\multirow{4}{*}{u-para}
 & FlatIP & 0.547 & 0.681 & --- \\
 & Soft O2 & \textbf{0.648} & 0.735 & --- \\
 & Hard hydr. & 0.592 & 0.571 & --- \\
 & Shuffled O2 & 0.469 & 0.610 & --- \\
\bottomrule
\end{tabular}
\end{table}
...
\multirow{4}{*}{exact}
 & FlatIP & 0.692 & 0.806 & --- \\
 & Soft O2 & \textbf{0.752} & 0.848 & --- \\
 & Hard hydr. & 0.612 & 0.615 & --- \\
 & Shuffled O2 & 0.570 & 0.747 & --- \\
\midrule
\multirow{4}{*}{advice-recall}
 & FlatIP & 0.332 & 0.464 & --- \\
 & Soft O2 & \textbf{0.472} & 0.540 & --- \\
 & Hard hydr. & 0.394 & 0.403 & --- \\
 & Shuffled O2 & 0.348 & 0.467 & --- \\
\midrule
\multirow{4}{*}{u-para}
 & FlatIP & 0.568 & 0.718 & --- \\
 & Soft O2 & \textbf{0.759} & 0.819 & --- \\
 & Hard hydr. & 0.596 & 0.594 & --- \\
 & Shuffled O2 & 0.592 & 0.712 & --- \\
\bottomrule
\end{tabular}
\end{table}
